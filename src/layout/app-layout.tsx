...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiLogOut, FiClock } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'hr-manager', 'employee', 'team-leader', 'it-administrator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Leaves', path: '/leaves', entity: 'leave', service: AccessServiceEnum.PROJECT, icon: FiLogOut },
